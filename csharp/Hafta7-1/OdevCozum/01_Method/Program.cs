namespace _01_Method
{
    internal class Program
    {
        ...
        {
            //static void KelimeSayilariniGoster isminde bir metod tanımlayın ve parametresi string metin olsun. Bu metod string türünde verilen metnin içindeki kelimeleri ayrıştırarak hangi kelimenin ne kaçkez tekrar ettiğini ekranda göstersin.
        ...
        static void KelimeSayilariniGoster(string metin)
        {
            ...
            //split ile kelimeyi parçalayarak kelimenin içinden ayıraçtaki öğeleri çıkarıyoruz.
